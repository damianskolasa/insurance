...
public class Contract implements Serializable {
	...
	public Long getHealthCareDataId() {
		return healthCareDataId;
	}

	public void setHealthCareDataId(Long healthCareDataId) {
		this.healthCareDataId = healthCareDataId;
	}
